...
export default function AntecedentesClinicosScreen() {
  ...
  const [outros, setOutros] = useState(true); // Falso, mas 'true' para o mock da sua tela
  const [outrosTexto, setOutrosTexto] = useState('');

  const handleNext = () => {
    // Navega para a Tela 9, mantendo o ID do paciente
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <ToggleButton
          ...
          value={infeccaoUrinaria}
          onToggle={setInfeccaoUrinaria}
        />
        <ToggleButton
          label="Infertilidade"
          value={infertilidade}
          onToggle={setInfertilidade}
        />
        <ToggleButton
          label="Dificul. Amamentação"
          value={dificulAmamentacao}
          onToggle={setDificulAmamentacao}
        />
        <ToggleButton
          label="Cardiopatia"
          value={cardiopatia}
          onToggle={setCardiopatia}
        />
        <ToggleButton
          label="Tromboembolismo"
          value={tromboembolismo}
          onToggle={setTromboembolismo}
        />
        <ToggleButton
        ...
        />
        <ToggleButton
          label="Cir. Pélv. Uterina"
          value={cirurgiaPelvica}
          onToggle={setCirurgiaPelvica}
        />
        <ToggleButton
          label="Cirurgia"
          value={cirurgia}
          onToggle={setCirurgia}
        />
        <ToggleButton
          label="Outros"
          value={outros}
